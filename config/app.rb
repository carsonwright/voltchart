Volt.configure do |config|
  ...
  #######################################
  config.domain = 'testapp.com'
  config.app_name = 'Testapp'
  config.mailer.from = 'Testapp <no-reply@testapp.com>'
  ...
  #
  config.app_secret = 'JOjdoC_GbIEfr6Dzs9kYeZaFBDG7o9AZOuNrovtNJFKDZCDWNasVpLPUsPw7dkna67o'
